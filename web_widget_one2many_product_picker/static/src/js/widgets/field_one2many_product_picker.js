    ...
    function (require) {
        ...
        var FieldOne2ManyProductPicker = FieldOne2Many.extend({
            ...
            _getLinesDomain: function () {
                ...
                var lines = this.parent_controller.model.get(this.record.id).data[
                    this.name
                ].data;
            ...
            _updateSearchContext: function (group_id) {
                if (group_id >= 0) {
                    ...
                    this._searchContext.activeTest =
                        this._activeSearchGroup.active_test;
                } else {
            ...
            showGroup: function (group_id) {
                if (
                    ...
                    (this.searchGroups[group_id] &&
                        this._activeSearchGroup.name ===
                            this.searchGroups[group_id].name)
                ) {
                    return;
                }
                ...
                this._saveChain = this._saveChain.then(function () {
                    ...
                    return self.parent_controller
                        ...
                        .then(function () {
                            ...
                            var parent_record = model.get(
                                self.parent_controller.handle
                            );
                            return self.parent_controller.renderer
                                .confirmChange(parent_record, parent_record.id, [
                                    self.name,
                                ])
                                .then(function () {
